...
\usepackage[
  ...
  % Giảm khoảng trắng trong danh sách và tránh bảng endpoint bị tràn chữ
\usepackage{enumitem}
\usepackage{seqsplit}
...
\newcommand{\endpoint}[1]{\texttt{\seqsplit{#1}}}

% Tránh LaTeX kéo giãn khoảng trắng dọc để ép đều chiều cao trang
\raggedbottom
% Trang bìa
\usepackage{tikz}
\usetikzlibrary{calc}
...
% In toàn bộ tài liệu trong file .bib, kể cả tài liệu chưa được \cite{}
\nocite{*}
