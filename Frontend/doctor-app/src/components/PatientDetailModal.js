...
const styles = StyleSheet.create({
  ...
  modalSubtitle: { fontSize: 13, color: "#4B5563", marginTop: 2 },
  closeModalButton: { padding: 4 },
  modalCenterBox: { flex: 1, alignItems: "center", justifyContent: "center", padding: 24 },
  modalLoadingText: { marginTop: 12, fontSize: 14, color: "#6B7280" },
  modalErrorText: { marginTop: 12, fontSize: 14, color: "#DC2626", textAlign: "center" },
  modalScroll: { flex: 1 },
  modalScrollContent: { padding: 16 },
  modalSectionTitle: { fontSize: 14, fontWeight: "700", color: "#1F2937", marginBottom: 12, marginTop: 8 },
  infoGrid: { flexDirection: "row", gap: 12, marginBottom: 12 },
  infoCol: { flex: 1, backgroundColor: "#fff", borderRadius: 12, padding: 12, borderWidth: 1, borderColor: "#F1F5F9" },
  infoBlock: { backgroundColor: "#fff", borderRadius: 12, padding: 12, borderWidth: 1, borderColor: "#F1F5F9", marginBottom: 12 },
  ...
  vitalValue: { fontSize: 16, fontWeight: "800", color: "#1F2937", marginTop: 4 },
  modalFooter: { padding: 16, backgroundColor: "#fff", borderTopWidth: 1, borderTopColor: "#F1F5F9" },
  closeButton: {
  ...
  closeButtonText: { fontSize: 14, fontWeight: "600", color: "#4B5563" },
  modalTabContainer: {
    flexDirection: "row",
    backgroundColor: "#fff",
    borderBottomWidth: 1,
