                ...
                return (
                    <button
                        ...
                        className={`flex h-8 min-w-[2rem] items-center justify-center rounded-md border px-2 transition-colors ${isActive
                                ? "border-blue-500 bg-blue-500 text-white hover:bg-blue-600 dark:border-blue-500 dark:bg-blue-600 dark:hover:bg-blue-500"
