            ...
            <div className="bg-white rounded-xl shadow-md p-8">
                ...
                <form onSubmit={handleAssign} className="space-y-8">
                    ...
                    <div>
                        ...
                        <select
                            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-gray-50 text-lg"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-blue-50 p-6 rounded-xl border border-blue-100">
                            <label className="block text-lg font-medium text-blue-800 mb-3 flex items-center">
                                <FaUserMd className="mr-2" />
                                2. Chọn Bác sĩ phụ trách
                            </label>
                            <select
                                className="w-full p-3 border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white"
                        ...
                        <div className="bg-green-50 p-6 rounded-xl border border-green-100">
                            <label className="block text-lg font-medium text-green-800 mb-3 flex items-center">
                                <FaUserNurse className="mr-2" />
                                3. Chọn Y tá theo dõi
                            </label>
                            <select
                                className="w-full p-3 border border-green-200 rounded-lg focus:ring-2 focus:ring-green-500 bg-white"
                                value={selectedNurse}
