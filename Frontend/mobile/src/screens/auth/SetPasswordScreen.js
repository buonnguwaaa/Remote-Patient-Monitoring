      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.expiredCard}>
          ...
          <Text style={styles.expiredDesc}>
            Mật khẩu của bạn đã được khởi tạo thành công. Vui lòng đăng nhập bằng tài khoản của bạn để tiếp tục.
          </Text>
          <TouchableOpacity
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.expiredCard}>
          ...
          <Text style={styles.expiredDesc}>
            Liên kết kích hoạt tài khoản chỉ có hiệu lực trong 15 phút. Vui lòng dùng tính năng Quên mật khẩu hoặc liên hệ quản trị viên để nhận liên kết mới.
          </Text>
          <TouchableOpacity
            style={styles.primaryBtn}
            onPress={navigateToForgotPassword}
          >
            <Text style={styles.primaryBtnText}>Quên mật khẩu</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.secondaryBtn}
            onPress={navigateToLogin}
          >
            <Text style={styles.secondaryBtnText}>Về trang đăng nhập</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    );
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>
              {userName
                ? `Chào ${userName}, hãy đặt mật khẩu để kích hoạt tài khoản RPM của bạn.`
                : "Hãy đặt mật khẩu mới để kích hoạt tài khoản RPM."}
            </Text>
          </View>
