    ...
    <View style={styles.container}>
      ...
      <View style={styles.statsRow}>
        <View style={[styles.statChip, { backgroundColor: "#EFF6FF", borderColor: "#BFDBFE" }]}>
          <Text style={[styles.statVal, { color: "#1D4ED8" }]}>{totalPatients}</Text>
          <Text style={styles.statLabel}>Bệnh nhân</Text>
        </View>
        <View style={[styles.statChip, { backgroundColor: "#FEF2F2", borderColor: "#FECACA" }]}>
          <Text style={[styles.statVal, { color: "#DC2626" }]}>{patientsWithAlerts}</Text>
        ...
        <View style={[styles.statChip, { backgroundColor: "#F0FDF4", borderColor: "#BBF7D0" }]}>
          ...
          <Text style={styles.statLabel}>Ổn định</Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  statChip: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, paddingVertical: 8, borderRadius: 8, borderWidth: 1 },
