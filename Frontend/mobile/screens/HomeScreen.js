...
const measurements = [
    {
        ...
        updatedAt: "2025-11-24T08:31:00Z",
    },
    {
        id: "m2",
        patientId: "p1",
        ...
        updatedAt: "2025-11-24T07:01:00Z",
    },
    {
        id: "m3",
        patientId: "p1",
        ...
        note: "",
        recordedBy: "u1",
        createdAt: "2025-11-24T09:10:00Z",
        updatedAt: "2025-11-24T09:11:00Z",
    },
    {
        id: "m4",
        patientId: "p1",
        ...
        updatedAt: "2025-11-24T18:01:00Z",
    },
];
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: "#F2F4FF" }}>
            <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
                ...
                {/* TỔNG QUAN SINH HIỆU: 4 ô bp / glucose / spo2 / temp */}
                ...
                {alerts.map((alert) => {
                    ...
                    return (
                        ...
                        >
                            {/* Header: icon + label + severity pill */}
